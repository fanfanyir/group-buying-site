<template>
  <div id="ordergetdetail">
    <div id="detailbanner">
      <img id="left" src="../../../../assets/order/左箭头2.png" @click="waitget()">
      <p>{{msg}}</p>
      <input id="order_more" type="button" value="●●●"/>
    </div>
    <div id="order_status">
      <img src="../../../../assets/order/待收货.png">
      <p>卖家已发货</p>
      <p>剩{{day}}天{{hour}}小时自动确认</p>
    </div>
    <div id="address">
    ...
    <div id="footer">
      ...
      <input type="button" value="确认收货" @click="del2(payorder)"/>
    </div>
  </div>
</template>
